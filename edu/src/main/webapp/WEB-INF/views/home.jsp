...
<body id="body">
	...
	<div id="tableHeader">
		<span class="tableHeader_item checkBoxArea"></span> <span class="tableHeader_item">이름</span> <span class="tableHeader_item">나이</span> <span
			class="tableHeader_item">전화번호</span> <span class="tableHeader_item" id="lastItem">이메일</span>
	</div>
			...
			<form id="form" class="form" name="form" method="post" action="insertUser.do">
				...
				<div>
					<span class="textBox">나이
						<hr>
					</span> <input name="age" id="age" onfocus="this.select()" class="textArea" placeholder="..">
				</div>
				<br>
				<div>
					<span class="textBox">전화번호
						<hr>
					</span> <input name="phone" id="phone" onfocus="this.select()" class="textArea" placeholder="010-1234-5678">
				</div>
				<br>
				<div>
					<span class="textBox">이메일
						<hr>
					</span> <input type="email" name="email" id="email" onfocus="this.select()" class="textArea" placeholder="seed@it.com">
				</div>
				<br> <br>
			</form>
...
<script type="text/javascript">
									...
									.each(
											...
											function(i, v) {
												...
												if (i + 1 == data.userList.length) {
													listCount = data.userList.length;
													afterFunction();
												}
											});
						});
	...
	$(".deleteBtn").click(function() {
		...
		modal2.css("display", "block");
			...
			$("#smallModalText").text("삭제할 유저를 선택해주세요.");
			$(".smallModal").css("display","block");
		}
	});
	//삭제 모달 확인 버튼
